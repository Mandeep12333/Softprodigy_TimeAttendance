...
namespace GantnerMe.CustomControls
{
    public class CustomRadioButton : View
    {
        ...
        public bool Checked
        {
            get
            {
                return this.Get_Value<bool>(CheckedProperty);
            }
        ...
        public string Text
        {
            get
            {
                return this.Get_Value<string>(TextProperty);
            }
        ...
        public Color TextColor
        {
            get
            {
                return this.Get_Value<Color>(TextColorProperty);
            }
