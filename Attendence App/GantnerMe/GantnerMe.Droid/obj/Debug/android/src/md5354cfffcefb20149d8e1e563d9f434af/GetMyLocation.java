package md5354cfffcefb20149d8e1e563d9f434af;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GantnerMe.Droid.CommonClasses.GetMyLocation, GantnerMe.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GetMyLocation.class, __md_methods);
	}


	public GetMyLocation () throws java.lang.Throwable
	{
		super ();
		if (getClass () == GetMyLocation.class)
			mono.android.TypeManager.Activate ("GantnerMe.Droid.CommonClasses.GetMyLocation, GantnerMe.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
